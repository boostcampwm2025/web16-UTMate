...
export default function LoginPage() {
  return (
    <div className="bg-background flex min-h-screen items-center justify-center p-4 sm:p-8">
      <div className="border-border grid w-full max-w-6xl overflow-hidden rounded-2xl border shadow-2xl lg:grid-cols-2">
        {/* 왼쪽: 로그인 폼 */}
        <div className="bg-card flex flex-col justify-center p-8 sm:p-12 lg:p-16">
