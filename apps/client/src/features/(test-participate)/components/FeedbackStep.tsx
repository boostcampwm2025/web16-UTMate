...
export function FeedbackStep({ onSubmit, isLoading }: FeedbackStepProps) {
    ...
    <Card className="w-full max-w-3xl">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-muted rounded-lg p-4">
          ...
          <p className="text-muted-foreground text-xs">테스트 전체에 대한 의견을 자유롭게 남겨주세요.</p>
        </div>

        {/* 전체 피드백 입력 */}
        <div className="space-y-2">
          <h3 className="font-semibold">전체 피드백</h3>
          <p className="text-muted-foreground text-sm">테스트를 진행하면서 느낀 점이나 개선사항을 알려주세요.</p>
          <Textarea
