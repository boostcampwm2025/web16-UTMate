...
import type { ParticipantResponse, TestInfo } from '@/features/(test-participate)/types';

interface TestParticipateClientProps {
  initialTestInfo: TestInfo;
}

export function TestParticipateClient({ initialTestInfo }: TestParticipateClientProps) {
